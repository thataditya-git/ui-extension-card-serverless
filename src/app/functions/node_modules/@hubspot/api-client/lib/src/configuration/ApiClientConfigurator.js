...
class ApiClientConfigurator {
    ...
    static getMiddleware(config, observableRequestContextParam, observableResponseContextParam) {
        ...
        if (config.middleware) {
            middleware.push(...this.getCustomMiddleware(config, observableRequestContextParam, observableResponseContextParam));
        }
        return middleware;
    }
    static getCustomMiddleware(config, observableRequestContextParam, observableResponseContextParam) {
        var _a, _b;
        return ((_b = (_a = config.middleware) === null || _a === void 0 ? void 0 : _a.filter((m) => m.pre || m.post).map((m) => ({
            pre: (context) => {
