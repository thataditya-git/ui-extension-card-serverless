...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(invoiceId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (invoiceId === null || invoiceId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "invoiceId");
            }
    ...
    getById(invoiceId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (invoiceId === null || invoiceId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "invoiceId");
            }
            const localVarPath = '/crm/v3/objects/invoices/{invoiceId}'
                .replace('{' + 'invoiceId' + '}', encodeURIComponent(String(invoiceId)));
    ...
    update(invoiceId, simplePublicObjectInput, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (invoiceId === null || invoiceId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "invoiceId");
            }
