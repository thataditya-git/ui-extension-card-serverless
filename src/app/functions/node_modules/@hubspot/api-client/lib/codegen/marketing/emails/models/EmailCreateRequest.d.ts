...
export declare class EmailCreateRequest {
...
export declare enum EmailCreateRequestLanguageEnum {
    Af = "af",
    AfNa = "af-na",
    AfZa = "af-za",
    Agq = "agq",
...
export declare enum EmailCreateRequestStateEnum {
    Automated = "AUTOMATED",
...
export declare enum EmailCreateRequestSubcategoryEnum {
    AbMaster = "ab_master",
