...
export declare class PublicEmail {
...
export declare enum PublicEmailLanguageEnum {
    Af = "af",
    AfNa = "af-na",
    AfZa = "af-za",
    Agq = "agq",
...
export declare enum PublicEmailTypeEnum {
    AbEmail = "AB_EMAIL",
...
export declare enum PublicEmailStateEnum {
    Automated = "AUTOMATED",
