...
export declare class EmailUpdateRequest {
...
export declare enum EmailUpdateRequestLanguageEnum {
    Af = "af",
    AfNa = "af-na",
    AfZa = "af-za",
    Agq = "agq",
...
export declare enum EmailUpdateRequestStateEnum {
    Automated = "AUTOMATED",
...
export declare enum EmailUpdateRequestSubcategoryEnum {
    AbMaster = "ab_master",
